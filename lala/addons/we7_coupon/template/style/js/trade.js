			...
			var consume = {
				...
				'getuser': function(){
					...
					$('#username').blur(function(){
						...
						var type = $('#type').val();
						if(username) {
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=user&m=we7_coupon&', {'type':type, 'username':username}, function(data){
				...
				'submit': function() {
					...
					$('#form-consume #submit-form').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=consume&m=we7_coupon&', param, function(data){
								if(data != 'success') {
				...
				'submit': function() {
					...
					$('#form-credit .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=credit&m=we7_coupon', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
				...
				'submit': function() {
					...
					$('#form-card .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=card&m=we7_coupon&', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
				...
				'submit': function() {
					...
					$('#form-card .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=cardconsume&m=we7_coupon&', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
				...
				fields: {
					...
					cardsn: {
						validators: {
							...
							remote: {
								url: "./index.php?c=site&a=entry&do=cardmanage&op=cardsn&type=check&m=we7_coupon",
				...
				'submit': function() {
					...
					$('#form-card .btn-primary').click(function(){
						...
						if(Validator.isValid()) {
							...
							$.post('./index.php?c=site&a=entry&do=cardmanage&op=cardsn&m=we7_coupon&', param, function(data){
								if(data != 'success') {
									util.message(data, '', 'error');
									return false;
								} else {
